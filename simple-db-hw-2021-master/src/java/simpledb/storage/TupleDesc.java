...
public class TupleDesc implements Serializable {
    ...
    public Iterator<TDItem> iterator() {
        // some code goes here
        return new IteratorWrapper<>(tdItems);
    }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        for (int i = 0; i < td2.len; ++i) {
            typeAr[td1.len + i] = td2.tdItems[i].fieldType;
            fieldAr[td1.len + i] = td2.tdItems[i].fieldName;
        }
